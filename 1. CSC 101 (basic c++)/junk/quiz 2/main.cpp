        ...
        if(x>z){
            if(y>z){
                ...
                if(result>y){
                    ...
                    if(z<0){
                        if(y<0){
                            cout<<"Weird result is:"<<"("<<x<<"+"<<-1*z<<")"<<"+"<<-1*y<<"="<<weirdresult;
                        }
                        else{
                ...
                if(result>z){
                    ...
                    if(y<0){
                        ...
                        cout<<"Weird result is:"<<"("<<x<<"+"<<-1*y<<")"<<"+"<<-1*z<<"="<<weirdresult;
                        }
                        else{
                            cout<<"Weird result is:"<<"("<<x<<"+"<<-1*y<<")"<<"-"<<z<<"="<<weirdresult;
                        }
            ...
            //cout<<z<<">"<<x<<">"<<y<<">";
                ...
                if(result>x){
                    ...
                    if(y<0){
                        if(x<0){
                            cout<<"Weird result is:"<<"("<<z<<"+"<<-1*y<<")"<<"+"<<-1*x<<"="<<weirdresult;
                        }
                        else{
        ...
        if(y>z){
            if(x>z){
                ...
                if(result>x){
                    ...
                    if(z<0){
                        if(x<0){
                            cout<<"Weird result is:"<<"(<<y"<<"+"<<-1*z<<")"<<"+"<<-1*x<<"="<<weirdresult;
                        }
                        else{
                ...
                if(result>z){
                    ...
                    if(x<0){
                        if(x<0){
                            cout<<"Weird result is:"<<"("<<y<<"+"<<-1*x<<")"<<"+"<<-1*z<<"="<<weirdresult;
                        }
                        else{
            ...
            result=(z-x);
                ...
                if(result>y){
                    ...
                    if(x<0){
                        if(y<0){
                            cout<<"Weird result is:"<<"("<<z<<"+"<<-1*x<<")"<<"+"<<-1*y<<"="<<weirdresult;
                        }
                        else{
